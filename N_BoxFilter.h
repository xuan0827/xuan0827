...
{
	public:
		N_BoxFilter ( double iBaseSize, N_Image& iImage );
...
inline N_BoxFilter::N_BoxFilter ( double iBaseSize, N_Image& iImage )
{
	_ii = iImage.getIntegralImage();
	_im_width = iImage.getWidth();
	_im_height = iImage.getHeight();

	_basesize = N_Math::Round ( iBaseSize ); // convert to integer
...
inline double N_BoxFilter::getDxxWithX ( unsigned int x ) const
{
...
inline double N_BoxFilter::getDyyWithX ( unsigned int x ) const
{
...
inline double N_BoxFilter::getDxyWithX ( unsigned int x ) const
{
...
inline double N_BoxFilter::getDetWithX ( unsigned int x ) const
{
...
inline void	N_BoxFilter::setY ( unsigned int y )
{
...
inline bool N_BoxFilter::checkBounds ( int x, int y ) const
{
