...
#ifndef __N_parallelsurf_keypointdescriptorcontext_h
#define __N_parallelsurf_keypointdescriptorcontext_h
...
*/
class N_KeyPointDescriptorContext
{
	public:
		N_KeyPointDescriptorContext ( int iSubRegions, int iVecLen, double iOrientation );
		~N_KeyPointDescriptorContext();
	...
	private:
		...
		N_KeyPointDescriptorContext();
		N_KeyPointDescriptorContext ( const N_KeyPointDescriptorContext& );
		N_KeyPointDescriptorContext& operator= ( N_KeyPointDescriptorContext& ) throw();
