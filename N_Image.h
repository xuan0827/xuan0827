...
#ifndef __N_parallelsurf_image_h
#define __N_parallelsurf_image_h
...
{
	public:
		N_Image() : _ii ( 0 ), _width ( 0 ), _height ( 0 ) {};

		// Constructor from a pixel array
		N_Image ( const unsigned char **iPixels, unsigned int iWidth, unsigned int iHeight );
