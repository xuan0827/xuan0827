...
#ifndef __N_parallelsurf_keypointdetector_h
#define __N_parallelsurf_keypointdetector_h
...
class N_KeyPointInsertor
{
	public:
		virtual void operator() ( const N_KeyPoint &k ) = 0;
};

class N_KeyPointDetector
{
	public:
		 ...
		 */
		void detectKeyPoints ( N_Image& iImage, N_KeyPointInsertor& iInsertor );
	...
	private:
		...
		bool calcTrace ( N_Image& iImage, double iX, double iY, double iScale, int& oTrace );
